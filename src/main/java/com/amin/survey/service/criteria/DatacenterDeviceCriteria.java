...
/**
 * Criteria class for the {@link com.amin.survey.domain.DatacenterDevice} entity. This class is used
 * in {@link com.amin.survey.web.rest.DatacenterDeviceResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /datacenter-devices?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DatacenterDeviceCriteria implements Serializable, Criteria {

    /**
     * Class for filtering DataCenterDeviceType
     */
    public static class DataCenterDeviceTypeFilter extends Filter<DataCenterDeviceType> {

        public DataCenterDeviceTypeFilter() {}

        public DataCenterDeviceTypeFilter(DataCenterDeviceTypeFilter filter) {
            super(filter);
        }

        @Override
        public DataCenterDeviceTypeFilter copy() {
            return new DataCenterDeviceTypeFilter(this);
        }
    }
    ...
    private DataCenterDeviceTypeFilter deviceType;
    ...
    public DatacenterDeviceCriteria() {}

    public DatacenterDeviceCriteria(DatacenterDeviceCriteria other) {
    ...
    @Override
    public DatacenterDeviceCriteria copy() {
        return new DatacenterDeviceCriteria(this);
    }
    ...
    public DataCenterDeviceTypeFilter getDeviceType() {
        return deviceType;
    }

    public DataCenterDeviceTypeFilter deviceType() {
        if (deviceType == null) {
            deviceType = new DataCenterDeviceTypeFilter();
        }
        return deviceType;
    }

    public void setDeviceType(DataCenterDeviceTypeFilter deviceType) {
    ...
    public boolean equals(Object o) {
        ...
        final DatacenterDeviceCriteria that = (DatacenterDeviceCriteria) o;
        return (
    ...
    public String toString() {
        return "DatacenterDeviceCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
