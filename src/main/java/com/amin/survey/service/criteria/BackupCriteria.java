...
/**
 * Criteria class for the {@link com.amin.survey.domain.Backup} entity. This class is used
 * in {@link com.amin.survey.web.rest.BackupResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /backups?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class BackupCriteria implements Serializable, Criteria {
    ...
    private StringFilter question6;

    private StringFilter question7;
    ...
    public BackupCriteria(BackupCriteria other) {
        ...
        this.question6 = other.question6 == null ? null : other.question6.copy();
        this.question7 = other.question7 == null ? null : other.question7.copy();
        this.formId = other.formId == null ? null : other.formId.copy();
        this.distinct = other.distinct;
    }

    @Override
    public BackupCriteria copy() {
        return new BackupCriteria(this);
    }
    ...
    public StringFilter getQuestion6() {
        return question6;
    }

    public StringFilter question6() {
        if (question6 == null) {
            question6 = new StringFilter();
        }
        return question6;
    }

    public void setQuestion6(StringFilter question6) {
        this.question6 = question6;
    }

    public StringFilter getQuestion7() {
        return question7;
    }

    public StringFilter question7() {
        if (question7 == null) {
            question7 = new StringFilter();
        }
        return question7;
    }

    public void setQuestion7(StringFilter question7) {
    ...
    public boolean equals(Object o) {
        ...
        final BackupCriteria that = (BackupCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, question1, question2, question3, question4, question5, question6, question7, formId, distinct);
    }
    ...
    public String toString() {
        return "BackupCriteria{" +
            ...
            (question6 != null ? "question6=" + question6 + ", " : "") +
            (question7 != null ? "question7=" + question7 + ", " : "") +
