...
/**
 * Criteria class for the {@link com.amin.survey.domain.Internet} entity. This class is used
 * in {@link com.amin.survey.web.rest.InternetResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /internets?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InternetCriteria implements Serializable, Criteria {
    ...
    public InternetCriteria(InternetCriteria other) {
    ...
    @Override
    public InternetCriteria copy() {
        return new InternetCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InternetCriteria that = (InternetCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, question1, question2, question3, question4, question5, question6, formId, distinct);
    }
