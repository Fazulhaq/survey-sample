...
public class Server implements Serializable {
    ...
    public Server question1(String question1) {
    ...
    public Server question2(String question2) {
    ...
    public Server question3(String question3) {
    ...
    public Server question4(String question4) {
    ...
    public Server question5(String question5) {
    ...
    public Server question6(String question6) {
    ...
    public Server question7(String question7) {
