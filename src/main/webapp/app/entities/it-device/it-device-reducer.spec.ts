...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './it-device.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITDEVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ITDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ITDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ITDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ITDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ITDEVICE actions', async () => {
      const expectedActions = [
        {
