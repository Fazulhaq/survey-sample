...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './datacenter-device.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATACENTERDEVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DATACENTERDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DATACENTERDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DATACENTERDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DATACENTERDEVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DATACENTERDEVICE actions', async () => {
      const expectedActions = [
        {
