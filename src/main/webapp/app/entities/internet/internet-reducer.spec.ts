...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './internet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERNET_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTERNET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERNET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERNET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERNET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERNET actions', async () => {
      const expectedActions = [
        {
