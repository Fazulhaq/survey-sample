...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './network-config-check-list.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NETWORKCONFIGCHECKLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_NETWORKCONFIGCHECKLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NETWORKCONFIGCHECKLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NETWORKCONFIGCHECKLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NETWORKCONFIGCHECKLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NETWORKCONFIGCHECKLIST actions', async () => {
      const expectedActions = [
        {
