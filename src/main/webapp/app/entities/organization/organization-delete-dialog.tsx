...
export const OrganizationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="surveySampleApp.organization.delete.question">
        <Translate contentKey="surveySampleApp.organization.delete.question" interpolate={{ id: organizationEntity.id }}>
