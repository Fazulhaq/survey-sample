...
export const ServerDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/server' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="surveySampleApp.server.delete.question">
        <Translate contentKey="surveySampleApp.server.delete.question" interpolate={{ id: serverEntity.id }}>
