...
interface SurveyNetworkConfigCheckListDetailProps {
  formId: string;
}

export const SurveyNetworkConfigCheckListDetail: React.FC<SurveyNetworkConfigCheckListDetailProps> = ({ formId }) => {
...
export default SurveyNetworkConfigCheckListDetail;
