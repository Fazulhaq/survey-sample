...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './backup.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BACKUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_BACKUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BACKUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BACKUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BACKUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BACKUP actions', async () => {
      const expectedActions = [
        {
