...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './system.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_SYSTEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SYSTEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SYSTEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SYSTEM actions', async () => {
      const expectedActions = [
        {
