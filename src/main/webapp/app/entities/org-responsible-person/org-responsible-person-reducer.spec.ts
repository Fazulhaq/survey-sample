...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './org-responsible-person.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGRESPONSIBLEPERSON_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORGRESPONSIBLEPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORGRESPONSIBLEPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORGRESPONSIBLEPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORGRESPONSIBLEPERSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORGRESPONSIBLEPERSON actions', async () => {
      const expectedActions = [
        {
